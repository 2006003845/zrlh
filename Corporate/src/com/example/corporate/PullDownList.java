...
public class PullDownList {
	...
	public void setPullOnItemClickListener(
			PullOnItemClickListener onPullItemClickListener) {
	 ...
	 *            数据源
	 */
	public PullDownList(Activity _activity, View _parentView,
			View _ShowlocationView, ArrayList<Obj> _data) {
		activity = _activity;
...
//		_ShowlocationView.getLocationOnScreen(location);
	...
	private void initPopuWindow() {
		View loginwindow = (View) activity.getLayoutInflater().inflate(
				R.layout.popupwindow_pull_down, null);
		listView = (ListView) loginwindow
				.findViewById(R.id.popupwindow_pulldown_list);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				onItemClickListener.onPullItemClick(arg2);
	...
	public void popupWindwShowing() {
		selectPopupWindow.showAtLocation(parentView, Gravity.NO_GRAVITY,
