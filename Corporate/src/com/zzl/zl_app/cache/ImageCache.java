...
public class ImageCache {
	...
	public Bitmap getUnSyncImgCachFromDisk(Context context, String imgName)
			throws MalformedURLException, IOException {

		Bitmap bm = BitmapCache.getInstance().getBitmap(imgName);
		if (bm == null) {
			bm = localMemory.getBitmap(imgName);
			if (bm != null) {
				setImgKey2(imgName, bm);
			}
		}
		return bm;
	}
