...
public class Constant {
  ...
  public static float SCREEN_WIDTH_STANDARD = 800; // 屏幕标准宽度
  ...
  // 预加载的图片ID数组列表
  public static int[] PIC_ID = {R.drawable.ground,// 0-地面
  ...
  // 预加载白色数字图片ID数组列表
  public static int[] NUM_BS_ID = {R.drawable.num_bs_0,// 白色数字0
  ...
  // 加载黄色数字图片ID数组列表
  public static int[] NUM_HS_ID = {R.drawable.num_hs_0,// 黄色数字0
  ...
  // 加载紫色数字图片ID数组列表
  public static int[] NUM_ZS_ID = {R.drawable.num_zs_0,// 紫色数字0
  ...
  // 其余自己自定义图片的ID数组列表
  public static int[] OTHER_PIC_ID = {R.drawable.gk_1, // 0第一关
  ...
  public static void loadPic(Resources res) {
    ...
    for (int i = 0; i < OTHER_PIC_ID.length; i++) {
      ...
      OTHER_PIC_ARRAY[i] =
          PicLoadUtil.scaleToFitXYRatio(OTHER_PIC_ARRAY[i], yMainRatio, yMainRatio);
    }
    ...
    // 弹弓图片按照高度缩放
    PIC_ARRAY[22] =
        PicLoadUtil.scaleToFitXYRatio(PIC_ARRAY[22], yMainRatio * 0.7f, yMainRatio * 0.7f);
    // 鼠头图片按照高度缩放
  ...
  public static BodyType[][] typeA = {
      // 第一关的贴图物体类型
      {BodyType.DM, BodyType.HNTZ, BodyType.HNTZ, BodyType.ST, BodyType.XM, BodyType.BK,
          BodyType.MT, BodyType.ST, BodyType.ST, BodyType.XM, BodyType.MT, BodyType.BK,
          BodyType.ST, BodyType.ST, BodyType.ST, BodyType.ST, BodyType.ST, BodyType.ST,
          BodyType.ST, BodyType.ST, BodyType.ST, BodyType.ST, BodyType.ST, BodyType.MT,
          BodyType.MT, BodyType.BK,},
      // 第二关的贴图物体类型
      {BodyType.DM, BodyType.HNTZ, BodyType.HNTZ, BodyType.BK, BodyType.XM, BodyType.MT,
          BodyType.BK, BodyType.MT, BodyType.ST, BodyType.XM, BodyType.ST, BodyType.XM,
          BodyType.ST, BodyType.ST, BodyType.ST, BodyType.ST, BodyType.ST, BodyType.ST,
          BodyType.MT, BodyType.MT, BodyType.BK,},
      // 第三关的贴图物体类型
      {BodyType.DM, BodyType.HNTZ, BodyType.ST, BodyType.ST, BodyType.XM, BodyType.XM, BodyType.MT,
          BodyType.BK, BodyType.BK, BodyType.ST, BodyType.XM, BodyType.XM, BodyType.ST}};
  ...
  public static float[][][] LOCATION = {
      // 第一关贴图物体的初始位置
      { {0, 440}, {760, 400}, {1000, 360}, {840, 340}, {870, 360}, {920, 340}, {840, 320},
          {920, 300}, {1000, 300}, {1030, 320}, {1080, 300}, {1000, 280}, {1080, 260}, {840, 300},
          {1000, 260}, {880, 300}, {1040, 260}, {1240, 260}, {1340, 260}, {1240, 240}, {1240, 60},
          {1340, 60}, {1240, 40}, {1120, 300}, {1180, 300}, {1120, 280}},
      // 第二关贴图物体的初始位置
      { {0, 440}, {760, 400}, {1000, 400}, {820, 340}, {850, 360}, {900, 340}, {820, 320},
          {860, 300}, {940, 340}, {960, 400}, {1010, 320}, {1030, 360}, {1240, 260}, {1340, 260},
          {1240, 240}, {1240, 60}, {1340, 60}, {1240, 40}, {1080, 300}, {1140, 300}, {1080, 280}},
      // 第三关贴图物体的初始位置
      { {0, 440}, {760, 400}, {730, 320}, {730, 300}, {920, 360}, {880, 360}, {770, 200},
          {800, 260}, {800, 240}, {840, 260}, {800, 200}, {860, 260}, {960, 100}}};

  // 贴图物体的目标尺寸
  public static float[][][] SIZE = {
      // 第一关贴图物体的目标尺寸
      { {2000, 40}, {200, 40}, {240, 80}, {20, 60}, {40, 40}, {20, 60}, {100, 20}, {20, 20},
          {20, 60}, {40, 40}, {20, 60}, {100, 20}, {20, 20}, {20, 20}, {20, 20}, {20, 20},
          {20, 20}, {20, 180}, {20, 180}, {120, 20}, {20, 180}, {20, 180}, {120, 20}, {20, 60},
          {20, 60}, {80, 20}},
      // 第二关贴图物体的目标尺寸
      { {2000, 40}, {200, 40}, {200, 40}, {20, 60}, {40, 40}, {20, 60}, {100, 20}, {20, 20},
          {20, 60}, {40, 40}, {20, 80}, {40, 40}, {20, 180}, {20, 180}, {120, 20}, {20, 180},
          {20, 180}, {120, 20}, {20, 60}, {20, 60}, {80, 20}},
      // 第三关贴图物体的目标尺寸
      { {2000, 40}, {300, 40}, {20, 120}, {170, 20}, {40, 40}, {40, 40}, {20, 100}, {20, 40},
          {60, 20}, {20, 40}, {40, 40}, {40, 40}, {20, 300}}};
  ...
  // 得到图片的编号
  public static int[] PIC_NUM = {R.drawable.bg, // 0背景图片
  ...
  public static float[][] getLocaltionAndWH() {
    ...
    LOCALTION_BUTTON =
        new float[][] {
            ...
            // 点击设置按钮后弹出的声音按钮
            {SET_X_OFFSET + SET_SPACE,
                SCREEN_HEIGHT - PE_ARRAY[1].getHeight() - (PE_ARRAY[10].getHeight() * 2),
                PE_ARRAY[10].getWidth(), PE_ARRAY[10].getHeight()},
            // 点击设置按钮后弹出的查看公司信息按钮
            {SET_X_OFFSET + SET_SPACE,
                SCREEN_HEIGHT - PE_ARRAY[1].getHeight() - (PE_ARRAY[11].getHeight() * 3),
                PE_ARRAY[11].getWidth(), PE_ARRAY[11].getHeight()},
            // 点击设置按钮后弹出的查看分数信息按钮
            {SET_X_OFFSET + SET_SPACE,
                SCREEN_HEIGHT - PE_ARRAY[1].getHeight() - (PE_ARRAY[12].getHeight() * 4),
                PE_ARRAY[12].getWidth(), PE_ARRAY[12].getHeight()},
            // 点击的是“PLAY”按钮
            {(SCREEN_WIDTH - PE_ARRAY[6].getWidth()) / 2,
                (SCREEN_HEIGHT - PE_ARRAY[6].getHeight()) / 2, PE_ARRAY[6].getWidth(),
                PE_ARRAY[6].getHeight()}};
