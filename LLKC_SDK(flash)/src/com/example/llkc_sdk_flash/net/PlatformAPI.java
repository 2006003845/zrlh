...
public class PlatformAPI {
	...
	public static String Orgid = "LLKC";

	// public static String requestUrl =
	// "http://221.130.10.95/profession/Servlet";

	// 测试地址
	// public static String BaseUrl =
	// "http://192.168.0.19:9990/findwork/discuz/";
	// public static String PHPBaseUrl =
	// "http://192.168.0.13:8060/app/api.php?";
