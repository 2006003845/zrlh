...
public class ExpertAnswersContentActivity extends GameActivity {

	private static ExpertAnswersContentActivity mContext;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new ExpertAnswersContentTask().execute((Void) null);
	...
	private class ExpertAnswersContentTask extends
