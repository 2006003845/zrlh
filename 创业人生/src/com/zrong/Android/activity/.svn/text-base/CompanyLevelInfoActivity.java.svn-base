...
public class CompanyLevelInfoActivity extends GameActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		title.setText(MainActivity.resources.getString(R.string.Company));
		...
		returnback.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				CompanyLevelInfoActivity.this.finish();
			}
		});
		// 取消键
		...
		levelupConfirm.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (isMatchToLevelUp()) {
					...
					// 弹出提示框---级别不够，无法升级
					Toast toast = Toast.makeText(CompanyLevelInfoActivity.this,
