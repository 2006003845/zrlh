...
/**
 * XNs models an XML namespace. XNs are usually created as attributes on XElems using the <code>XElem.defineNs()</code> and <code>XElem.defineDefaultNs()</code> methods. Two XNs instances are equal if they have the same uri.
 * 
 * @author Brian Frank
 * @creation 6 Apr 02
