 ...
 * <li>PKZIP containing any other format with 0x504b0304 byte order mark (assumes text is first zip entry)</li>
 * <li>Anything else assumes UTF-8;</li>
 * </ul>
 * 
 * @author Brian Frank
 * @creation 19 Apr 05
 * @version $Revision$ $Date: 4-May-05 9:01:56 AM$
 */
	...
	private int readUtf8 (int c0) throws IOException
	{
		...
		switch(c0 >> 4)
		{
			...
			case 15:
				...
				/*
				 * I think this is valid, but Java doesn't seem to output characters this high - so cap things below this c1 = in.read(); c2 = in.read(); c3 = in.read(); if (((c1 & 0xC0) != 0x80) || ((c2 & 0xC0) != 0x80) || ((c3 & 0xC0) != 0x80)) throw new UTFDataFormatException(); return ((c0 & 0x07) << 18) | ((c1 & 0x3F) << 12) | ((c2 & 0x3F) << 6) | ((c3 & 0x3F) << 0);
				 */
				throw new UTFDataFormatException(Integer.toHexString(c0));
			default:
				throw new UTFDataFormatException(Integer.toHexString(c0));
