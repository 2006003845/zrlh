...
public class PolicyInfoContentActivity extends GameActivity {

	private static PolicyInfoContentActivity mContext;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new PolicyInfoTask().execute((Void) null);// 执行
	...
	private Dialog buildMessageDialog(Context context, String message) {
		...
		builder.setPositiveButton(mContext.getResources().getString(R.string.ensure), new DialogInterface.OnClickListener() {
