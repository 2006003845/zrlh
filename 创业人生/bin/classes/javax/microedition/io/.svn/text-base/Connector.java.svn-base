...
import com.zrong.Android.io.AndroidHTTPConnection;
import com.zrong.Android.io.AndroidSocketConnection;
import com.zrong.Android.io.AndroidURLConnection;
import com.zrong.Android.io.file.AndroidFileConnection;
...
public class Connector
{
     ...
     * Notice:Flag of timeouts have no effect.
     * @param name
     * @param mode
     * @param timeouts
     * @return
