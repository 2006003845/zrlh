...
import com.zhong.view.PinnedHeaderListView.PinnedHeaderAdapter;

/**
 * 显示城市的Adapter
 */
public class CityAdapter extends BaseAdapter implements SectionIndexer, PinnedHeaderAdapter, OnScrollListener {
	...
	public CityAdapter(Context context, List<City> cities, Map<String, List<City>> map, List<String> sections, List<Integer> positions) {
