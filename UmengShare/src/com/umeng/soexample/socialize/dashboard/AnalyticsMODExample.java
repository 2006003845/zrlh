	...
	public class ContentFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View root = inflater.inflate(
					R.layout.umeng_example_socialize_analyticsmod_example,
					container, false);
			...
			root.findViewById(R.id.reflush_entity).setOnClickListener(
					new OnClickListener() {
						...
						public void onClick(View v) {
							...
							controller.initEntity(getActivity(),
									new SocializeClientListener() {
										@Override
										public void onStart() {
											eCountTv.setText("正在刷新数据�?....");
										}

										@Override
										public void onComplete(int status,
												SocializeEntity entity) {
											eCountTv.setText(buildCountingInfo(controller
													.getEntity()));
										}
									});
		...
		private void integration(View root, final Handler handler) {
			root.findViewById(R.id.analytics_comment).setOnClickListener(
					new OnClickListener() {
						@Override
						public void onClick(View v) {
							int count = Integer.parseInt(repeatEt.getText()
									.toString());
							String descript = desEt.getText().toString();
							...
							for (int i = 0; i < count; i++) {
								 ...
								 * 
								 * @param context
								 *            （不可null�? * @param comment
								 *            评论内容封装对象 （不可null�? * @param
								 *            platforms 评论并分享的平台信息（可多�?，可null�?
								 *            * @param imageBytes 评论并分享的内容图片
								 *            （可null�? * @param listener
								 *            异步回调（可null�?
								 */
								controller.postComment(getActivity(),
										socializeComment,
			...
			root.findViewById(R.id.analytics_share).setOnClickListener(
					new OnClickListener() {
						@Override
						public void onClick(View v) {
							int count = Integer.parseInt(repeatEt.getText()
							...
							String descript = desEt.getText().toString();
							/*
							 * descript 参数是对controller 的描述，保证唯一性�?
							 * RequestType.ANALYTICS 参数用于标记controller对象用于统计
							 */
							UMSocialService controller = UMServiceFactory
									.getUMSocialService(descript,
											RequestType.ANALYTICS);
			...
			root.findViewById(R.id.analytics_share_wid).setOnClickListener(
					new OnClickListener() {
						@Override
						public void onClick(View v) {
							int count = Integer.parseInt(repeatEt.getText()
							...
							for (int i = 0; i < count; i++) {
								 ...
								 *            (不可null)
								 * @param wid
								 *            weiboId（不可null�? * @param platform
								 *            分享平台(不可null)
								 * @param listener
								 *            (可null)
								 */
								controller.postShareByID(getActivity(),
										"1234567890", "usid", SHARE_MEDIA.SINA,
										new SnsPostListener() {
											@Override
											public void onStart() {
											}
			...
			root.findViewById(R.id.analytics_like).setOnClickListener(
					new OnClickListener() {
						@Override
						public void onClick(View v) {
							int count = Integer.parseInt(repeatEt.getText()
							...
							for (int i = 0; i < count; i++) {
								 ...
								 *            异步回调(可null)
								 */
								controller.postLike(getActivity(),
										new SocializeClientListener() {
											@Override
											public void onStart() {
			...
			root.findViewById(R.id.analytics_unlike).setOnClickListener(
					new OnClickListener() {
						@Override
						public void onClick(View v) {
							int count = Integer.parseInt(repeatEt.getText()
							...
							for (int i = 0; i < count; i++) {
								 ...
								 *            异步回调(可null)
								 */
								controller.postUnLike(getActivity(),
										new SocializeClientListener() {
											@Override
											public void onStart() {
