...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // QQ SSO handler
        //controller.getConfig().setQZoneSsoHandler(new QZoneSsoHandler(getActivity()));

        root.findViewById(R.id.ucenter_info_interface).setOnClickListener(new OnClickListener() {
            @Override
        ...
        root.findViewById(R.id.ucenter_native_oauth).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                controller.showLoginDialog(mContext, null);
            }
        });
        ...
        root.findViewById(R.id.platform_info).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                controller.getPlatformInfo(mContext, SHARE_MEDIA.SINA, new UMDataListener() {
                    @Override
                    public void onStart() {
                    ...
                    public void onComplete(int status, Map<String, Object> info) {
                        Toast.makeText(mContext, "mcode:" + status, 1).show();
        ...
        root.findViewById(R.id.update_user).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                 SnsAccount snsAccount = new SnsAccount( "近似神的",
                 Gender.MALE,
                 "http://www.fosss.org/Images/ShiJia.jpg",
                 "123456789");
                 SocializeClientListener listener = new
...
//                UMToken umToken = UMToken.buildToken(new SNSPair(SHARE_MEDIA.SINA.toString(),
//                        "2303004783"), "2.008kKrVC0idO6t0a8647ac8f86cjcC");
//                controller.uploadToken(mContext, umToken, new SocializeClientListener() {
//                    @Override
//                    public void onStart() {
//
//                    }
