...
public class PluginHelper implements ServiceConnection {
  ...
  private void fixMiUiLbeSecurity() throws ClassNotFoundException, NoSuchFieldException,
    ...
    if (mLoaders instanceof HashMap) {
      ...
      if ("com.lbe.security.client.ClientContainer$MonitoredLoaderMap".equals(mLoaders.getClass()
          .getName())) {
    ...
    if (mPackages instanceof HashMap) {
      ...
      if ("com.lbe.security.client.ClientContainer$MonitoredPackageMap".equals(mPackages.getClass()
          .getName())) {
        HashMap value = new HashMap();
        value.putAll(oldValue);
